...
extern struct keyboard_buffer * p_kb;

#define NR_SCAN_CODES 	0x80
#define MAP_COLS	2

#define KB_BUF_SIZE 100			/* 键盘数据缓冲区大小 */
...
#define PORT_KB_DATA	0x60		/* 0x60端口 */
#define PORT_KB_STATUS	0x64		/* 0x64端口 */
#define PORT_KB_CMD	0x64			/* 0x64端口 */

#define KBSTATUS_IBF	0x02		/* 输入缓冲区状态标志位 */
#define KBSTATUS_OBF	0x01		/* 输出缓冲区状态标志位 */
