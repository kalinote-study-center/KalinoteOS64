...
;=======	set the SVGA mode(VESA VBE)
 	...
 	mov	ax,	4F02h
 	; mov	bx,	4180h	;========================mode : 0x180 or 0x143(Hyper-v用不了)
 	mov	bx,	4118h	;========================mode : 0x118 KalinoteOS1.0中使用的这种图形模式(VMWare用不了)
 	int 	10h
